...
from models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet, csnet
...
def generate_model(opt):
    assert opt.model in [
        'resnet', 'resnet2p1d', 'preresnet', 'wideresnet', 'resnext', 'densenet', 'csnet'
    ]
    ...
    if opt.model == 'resnet':
        ...
        model = densenet.generate_model(model_depth=opt.model_depth,
                                        ...
                                        conv1_t_stride=opt.conv1_t_stride,
                                        no_max_pool=opt.no_max_pool)
    elif opt.model == 'csnet':
        model = csnet.generate_model(model_depth=opt.model_depth,
                                        n_classes=opt.n_classes,
                                        csn_type='ip')
