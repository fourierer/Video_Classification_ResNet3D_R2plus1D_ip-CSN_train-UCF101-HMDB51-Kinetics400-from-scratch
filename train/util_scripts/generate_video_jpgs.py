...
def class_process(class_dir_path, dst_root_path, ext, fps=-1, size=240):
    ...
    #print(class_dir_path.name) # 视频文件所在目录
    dst_class_path = dst_root_path / class_dir_path.name
    dst_class_path.mkdir(exist_ok=True) #  图像文件所在目录
...
if __name__ == '__main__':
    ...
    if args.dataset == 'activitynet':
        ...
        #print(class_dir_paths) #  输出各个视频类别的路径字典
        test_set_video_path = args.dir_path / 'test'
        #print(test_set_video_path) # /home/sunzheng/Video_Classification/ResNet3D/data/UCF-101/test加了个test类别
