...
from model_add_csnet import (generate_model, load_pretrained_model, make_data_parallel,
                   get_fine_tuning_parameters) # 从model.py中导入各种模型
...
def get_inference_utils(opt):
    ...
    inference_data, collate_fn = get_inference_data(
        ...
        temporal_transform) # video_path='./jpg_mix',annotation_path='./data_dj/ucf101-01.json',dataset='ucf-101',input_type='rgb',file_type='jpg',inference_subset='val'
